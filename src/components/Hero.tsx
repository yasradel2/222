...
export default function Hero({ onNavigate }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      {/* الصورة اتنقلت شمال */}
      <div
        className={`absolute bottom-0 left-0 lg:left-8 xl:left-16 h-full flex items-end transition-all duration-1000 ${
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 pt-20 lg:pt-0">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center min-h-screen py-20">
          ...
          {/* اللوجو + النص في النص */}
          <div
            className={`order-2 lg:order-2 text-center transition-all duration-700 ${
          ...
          {/* الأيقونات اتنقلت يمين النص */}
          <div
            className={`order-3 lg:order-3 space-y-6 transition-all duration-700 ${
          ...
          >
            {features.map((feat, i) => (
              <div
                key={feat.title}
                className="flex items-start gap-4 group text-right"
                style={{
